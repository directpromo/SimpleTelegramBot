...
const Lang_ChatFlow_UsersInWaitList = "Tem %s usuários na fila de atendimento.\nDiga <b>%s</b> para atender o róximo da fila.";
const Lang_ChatFlow_ChattingWithClient = "Você está conversando com <b>%s</b>.\nSuas mensagens serão encaminhadas.\nO chat será encerrado automaticamente após %s minutos de inatividade.\nDiga <b>%s</b> para encerrar o chat.";